                         ...
                         __global uchar4* resized_image)
{
    ...
    if (x < new_width && y < new_height) {
        ...
        uchar4 pixel = image[y * DOWN_RATIO * width + x * DOWN_RATIO];

        // Write pixel value to the resized image
        resized_image[y * new_width + x] = pixel;
    }
}


__kernel void to_grayscale(__global const uchar4* input,
